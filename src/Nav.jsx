                            ...
                            <>
                                <div className="flex items-center gap-[15px]">
                                    <div
                                        ...
                                        onClick={() => setAccountMenuOpen(!accountMenuOpen)} // Toggle visibility
                                    >
                                        ...
                                        <div
                                            className={`${accountMenuOpen
                                                ? "block opacity-100 z-[1]"
                                                : "hidden opacity-0 z-[-1]"
                                                } bg-gray-200 w-max rounded-md shadow-md absolute top-[45px] right-0 p-[10px] flex flex-col transition-all duration-300 gap-[5px]`}
                                        >
