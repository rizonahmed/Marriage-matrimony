        ...
        <div className="container mx-auto px-6 py-10">
            ...
            <div className="max-w-lg mx-auto bg-gray-50 p-6 rounded-lg shadow-md">
                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Self Biodata ID */}
                    <div>
                        <label htmlFor="selfBiodataId" className="block font-medium text-gray-700">
                            Self Biodata ID
                        </label>
                        <input
                            type="text"
                    ...
                    {/* Partner Biodata ID */}
                    <div>
                        <label htmlFor="partnerBiodataId" className="block font-medium text-gray-700">
                            Partner Biodata ID
                        </label>
                        <input
                            type="text"
                    ...
                    {/* Couple Image */}
                    <div>
                        <label htmlFor="coupleImage" className="block font-medium text-gray-700">
                            Couple Image Link
                        </label>
                        <input
                            type="url"
                    ...
                    {/* Success Story */}
                    <div>
                        <label htmlFor="successStory" className="block font-medium text-gray-700">
                            Success Story
                        </label>
                        <textarea
                            id="successStory"
